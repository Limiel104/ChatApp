...
object Constants {
    ...
    const val EDIT_EMAIL_SAVE_BUTTON = "EDIT_EMAIL_SAVE_BUTTON"
    const val EDIT_PASSWORD_SAVE_BUTTON = "EDIT_PASSWORD_SAVE_BUTTON"
    const val EDIT_PROFILE_INFO_SAVE_BUTTON = "EDIT_PROFILE_INFO_SAVE_BUTTON"
    const val EDIT_PROFILE_PICTURE_SAVE_BUTTON = "EDIT_PROFILE_PICTURE_SAVE_BUTTON"
    const val EDIT_EMAIL_BUTTON = "EDIT_EMAIL_BUTTON"
    const val EDIT_PASSWORD_BUTTON = "EDIT_PASSWORD_BUTTON"
    const val EDIT_PROFILE_INFO_BUTTON = "EDIT_PROFILE_INFO_BUTTON"
    const val CHOOSE_PROFILE_PICTURE_BUTTON = "CHOOSE_PROFILE_PICTURE_BUTTON"
